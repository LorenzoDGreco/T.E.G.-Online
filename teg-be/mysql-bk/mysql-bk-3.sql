...
CREATE TABLE IF NOT EXISTS `rooms` (
  ...
  `war` longtext NOT NULL,
  `lastUpdate` bigint(20) NOT NULL,
  `globalUpdate` bigint(20) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Volcando datos para la tabla teg-online.rooms: ~9 rows (aproximadamente)
REPLACE INTO `rooms` (`id`, `leaderUserId`, `turn`, `phase`, `status`, `name`, `password`, `config`, `war`, `lastUpdate`, `globalUpdate`) VALUES
	(1, 0, 1, 0, 0, 'asd', '123', '', '', 1, 1),
	(2, 42, 0, 0, 0, 'amanda', '', '{}', '{}', 0, 0),
	(3, 42, 0, 0, 0, 'amanda', '', '{}', '{}', 0, 0),
	(4, 42, 0, 0, 0, 'amanda', '', '{}', '{}', 0, 0),
	(5, 42, 0, 0, 0, 'amanda', '', '{}', '{}', 1714861483177, 1714861483177),
	(6, 42, 0, 0, 0, 'amanda', '', '{}', '{}', 1714861513852, 1714861513852),
	(7, 42, 0, 0, 0, 'amanda', '', '{}', '{}', 1714921622672, 1714921622672),
	(8, 42, 0, 0, 0, 'amanda', '123', '{}', '{}', 1714922330183, 1714922330183),
	(9, 42, 0, 0, 0, 'amanda', '123', '{}', '{}', 1714922626219, 1714922626219);

-- Volcando estructura para tabla teg-online.roomusers
...
-- Volcando datos para la tabla teg-online.roomusers: ~7 rows (aproximadamente)
REPLACE INTO `roomusers` (`id`, `roomId`, `userId`, `color`, `objetive`, `order`, `lastUpdate`) VALUES
	(1, 1, 2, 1, NULL, NULL, 0),
	(2, 1, 3, 0, NULL, NULL, 0),
	(3, 2, 4, 0, NULL, NULL, 0),
	(4, 2, 5, 0, NULL, NULL, 0),
	(5, 2, 6, 7, NULL, NULL, 0),
	(6, 1, 7, 2, NULL, NULL, 1),
	(7, 9, 42, 5, NULL, NULL, 1714922626744);
